...
class EducationRepository {
  ...
  Future<void> registerInstitute(Map<String, dynamic> instituteData) async {
    try {
      await _apiClient.dio.post(
        '/education/institutes/register',
        data: instituteData,
      );
    } catch (e) {
      developer.log(
        '❌ Failed to register institute: $e',
    ...
    try {
      await _apiClient.dio.post(
        ...
        data: {
          'course_id': courseId,
          'institute_id':
              instituteId, // Backend might infer student from token, but InstituteID needed for context
        },
      );
    } catch (e) {
      developer.log(
  ...
  Future<List<dynamic>> getMyCourses() async {
    try {
      ...
      developer.log(
        '⚠️ Failed to fetch my courses: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<void> logAttendance(
    ...
    try {
      await _apiClient.dio.post(
        '/education/batches/$batchId/attendance',
        data: {'student_id': studentId, 'date': date, 'status': status},
      );
    } catch (e) {
      developer.log(
        '❌ Failed to log attendance: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<List<dynamic>> getAttendanceLogs(String batchId, String date) async {
    try {
      ...
      developer.log(
        '⚠️ Failed to fetch attendance logs: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<Map<String, dynamic>> getBatchDetails(String batchId) async {
    try {
      ...
      developer.log(
        '⚠️ Failed to fetch batch details: $e',
        name: 'EducationRepository',
      );
      return {};
    }
  ...
  Future<List<dynamic>> getBatches([String? instituteId]) async {
    try {
      final path = instituteId != null
          ? '/admin/education/institutes/$instituteId/batches'
          : '/education/batches';
      final response = await _apiClient.dio.get(path);
      return response.data as List<dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch batches: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<dynamic> getMyInstitute() async {
    try {
      ...
      developer.log(
        '⚠️ Failed to fetch my institute: $e',
        name: 'EducationRepository',
      );
      return null;
    }
  ...
  Future<List<dynamic>> getStudents(String instituteId) async {
    try {
      final response = await _apiClient.dio.get(
        '/education/institutes/$instituteId/students',
      );
      return response.data as List<dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch students: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<void> verifyStudent(String enrollmentId, bool approved) async {
    try {
      await _apiClient.dio.patch(
        '/education/enrollments/$enrollmentId/verify',
        data: {'status': approved ? 'approved' : 'rejected'},
      );
    } catch (e) {
      developer.log(
        '❌ Failed to verify student: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<void> createFeeStructure(
    ...
    try {
      await _apiClient.dio.post(
        '/admin/education/institutes/$instituteId/fees',
        data: feeData,
      );
    } catch (e) {
      developer.log(
        '❌ Failed to create fee structure: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<List<dynamic>> getFeeStructures(String instituteId) async {
    try {
      ...
      developer.log(
        '⚠️ Failed to fetch fee structures: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<void> recordFeePayment(Map<String, dynamic> paymentData) async {
    try {
      ...
      developer.log(
        '❌ Failed to record fee payment: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<List<dynamic>> getStudentFeePayments(
    String instituteId,
    String studentId,
  ) async {
    try {
      final response = await _apiClient.dio.get(
        '/admin/education/institutes/$instituteId/students/$studentId/fees',
      );
      return response.data as List<dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch student fee payments: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<List<dynamic>> getAllInstituteFeePayments(String instituteId) async {
    try {
      final response = await _apiClient.dio.get(
        '/education/institutes/$instituteId/all-fees',
      );
      return response.data as List<dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch all institute fee payments: $e',
        name: 'EducationRepository',
      );
      return [];
    }
  ...
  Future<void> grantScholarship(
    String enrollmentId,
    double discountAmount,
  ) async {
    try {
      await _apiClient.dio.post(
        '/admin/education/enrollments/$enrollmentId/scholarship',
        data: {
  ...
  // Leads CRM
  Future<void> createStudentLead(
    String instituteId,
    Map<String, dynamic> leadData,
  ) async {
    try {
      await _apiClient.dio.post(
        '/admin/education/institutes/$instituteId/leads',
        data: leadData,
      );
    } catch (e) {
  ...
  Future<void> updateStudentLeadStatus(String leadId, String status) async {
    try {
      await _apiClient.dio.patch(
        '/admin/education/leads/$leadId/status',
        data: {'status': status},
      );
    } catch (e) {
      developer.log(
        '❌ Failed to update lead status: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<Map<String, dynamic>> issueCertificate(String enrollmentId) async {
    try {
      final response = await _apiClient.dio.post(
        '/admin/education/enrollments/$enrollmentId/certificate',
      );
      return response.data as Map<String, dynamic>;
    } catch (e) {
      developer.log(
  ...
  // Grading
  Future<void> submitPracticalScore(
    String batchId,
    String studentId,
    ...
    try {
      await _apiClient.dio.post(
        '/admin/education/batches/$batchId/students/$studentId/scores',
        data: scoreData,
      );
    } catch (e) {
      developer.log(
  ...
  Future<List<dynamic>> fetchStudentPracticalScores(
    String batchId,
    String studentId,
  ) async {
    try {
  ...
  Future<List<dynamic>> fetchPlacementListings(String? instituteId) async {
    try {
      final path = instituteId != null
          ? '/admin/education/institutes/$instituteId/placements'
          : '/admin/education/placements';
      final response = await _apiClient.dio.get(path);
      return response.data as List<dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch placements: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<void> createPlacementListing(
    String instituteId,
  ...
  Future<Map<String, dynamic>> getInstituteStats(String instituteId) async {
    try {
      final response = await _apiClient.dio.get(
        '/education/institutes/$instituteId/stats',
      );
      return response.data as Map<String, dynamic>;
    } catch (e) {
      developer.log(
        '⚠️ Failed to fetch institute stats: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
  ...
  Future<void> addLesson(
    ...
    try {
      await _apiClient.dio.post(
        '/education/courses/$courseId/lessons',
        data: lessonData,
      );
    } catch (e) {
  ...
  Future<List<TopStudent>> getLeaderboard() async {
    try {
      final response = await _apiClient.dio.get('/education/leaderboard');
      ...
      developer.log(
        '❌ Failed to fetch education leaderboard: $e',
        name: 'EducationRepository',
      );
      rethrow;
    }
