...
class _$NotificationModelImpl implements _NotificationModel {
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, title: $title, body: $body, payload: $payload, timestamp: $timestamp, isRead: $isRead, type: $type)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, body, payload, timestamp, isRead, type);
...
abstract class _NotificationModel implements NotificationModel {
  const factory _NotificationModel(
      ...
      @HiveField(3) final String? payload,
      @HiveField(4) required final DateTime timestamp,
      @HiveField(5) final bool isRead,
      @HiveField(6) final String type}) = _$NotificationModelImpl;
