...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _FetchNotifications value)?  fetchNotifications,TResult Function( _MarkRead value)?  markRead,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchNotifications() when fetchNotifications != null:
return fetchNotifications(_that);case _MarkRead() when markRead != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _FetchNotifications value)  fetchNotifications,required TResult Function( _MarkRead value)  markRead,}){
final _that = this;
switch (_that) {
case _FetchNotifications():
return fetchNotifications(_that);case _MarkRead():
return markRead(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _FetchNotifications value)?  fetchNotifications,TResult? Function( _MarkRead value)?  markRead,}){
final _that = this;
switch (_that) {
case _FetchNotifications() when fetchNotifications != null:
return fetchNotifications(_that);case _MarkRead() when markRead != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchNotifications,TResult Function( String id)?  markRead,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FetchNotifications() when fetchNotifications != null:
return fetchNotifications();case _MarkRead() when markRead != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchNotifications,required TResult Function( String id)  markRead,}) {final _that = this;
switch (_that) {
case _FetchNotifications():
return fetchNotifications();case _MarkRead():
return markRead(_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchNotifications,TResult? Function( String id)?  markRead,}) {final _that = this;
switch (_that) {
case _FetchNotifications() when fetchNotifications != null:
return fetchNotifications();case _MarkRead() when markRead != null:
return markRead(_that.id);case _:
...
class _MarkRead implements NotificationEvent {
  const _MarkRead({required this.id});
...
/// @nodoc
abstract mixin class _$MarkReadCopyWith<$Res> implements $NotificationEventCopyWith<$Res> {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<dynamic> notifications)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<dynamic> notifications)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<dynamic> notifications)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements NotificationState {
  const _Loaded({required final  List<dynamic> notifications}): _notifications = notifications;
