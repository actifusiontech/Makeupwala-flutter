...
class PlannerMenuScreen extends StatelessWidget {
  const PlannerMenuScreen({super.key});
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildSectionTitle('Planner Identity'),
                const SizedBox(height: AppSpacing.md),
                _buildMenuGrid(
                  context,
                  items: [
                ...
                _buildSectionTitle('Business & Finance'),
                const SizedBox(height: AppSpacing.md),
                _buildMenuGrid(
                  context,
                  items: [
