...
class WellnessRepository {
  ...
  Future<void> bookPackage(String packageId, String date, int guests) async {
    await _apiClient.post('/wellness/bookings', data: {
