...
class __$$SearchImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({Object? query = null, Object? category = freezed}) {
    return _then(
      _$SearchImpl(
        query: null == query
            ? _value.query
...
class _$SearchImpl implements _Search {
  const _$SearchImpl({required this.query, this.category});
  ...
  @override
  String toString() {
    return 'SearchEvent.search(query: $query, category: $category)';
  }
...
abstract class _Search implements SearchEvent {
  const factory _Search({required final String query, final String? category}) =
      _$SearchImpl;
...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Map<String, dynamic>> results) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Map<String, dynamic>> results)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<Map<String, dynamic>> results})
    : _results = results;
...
abstract class _Loaded implements SearchState {
  const factory _Loaded({required final List<Map<String, dynamic>> results}) =
      _$LoadedImpl;
