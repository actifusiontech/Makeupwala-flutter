...
class _$PaymentFailureImpl implements PaymentFailure {
  const _$PaymentFailureImpl({required this.message, this.code});
  ...
  @override
  String toString() {
    return 'Failure.payment(message: $message, code: $code)';
  }
...
abstract class PaymentFailure implements Failure {
  const factory PaymentFailure(
      {required final String message,
      final String? code}) = _$PaymentFailureImpl;
